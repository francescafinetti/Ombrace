    ...
    var body: some View {
        ZStack {
            ForEach(0..<2, id: \.self) { _ in
                Circle()
                    .fill(RadialGradient(gradient: Gradient(colors: gradientColors), center: .center, startRadius: 10, endRadius: 120))
                    ...
                    .overlay(
                        Circle()
                            .stroke(gradientColors.first?.opacity(0.1) ?? Color.yellow.opacity(0.1), lineWidth: 2)
