...
class InstructionViewModel {
    var instructions = [
        ...
        Instruction(id: 3, handsposition: handposition(left: .rightcheek, right: .righthand), text: "Just begin by bringing your left hand up to your cheek and cradling your face in your hand.", duration: 10, scale: 2.2, offset: CGSize(width: 0, height: 400)),
        Instruction(id: 4, handsposition: handposition(left: .rightcheek, right: .righthand), text: "You can close your eyes if you like, so that you can pay attention to what’s happening in your body.", duration: 12, scale: 2.2, offset: CGSize(width: 0, height: 400)),
        ...
        Instruction(id: 10, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Just taking a moment to feel these two hands, perhaps imagining that they are caring hands, offering kindness and warmth.", duration: 15, scale: 1.3, offset: CGSize(width: 0, height: 10)),
        ...
        Instruction(id: 20, handsposition: handposition(left: .heart, right: .stomach), text: "What happens in your nervous system, in your body, when you offer yourself a little bit of soothing, supportive touch?", duration: 15, scale: 1.5, offset: CGSize(width: 0, height: 150)),
        Instruction(id: 21, handsposition: handposition(left: .lefthand, right: .righthand), text: "I want to invite you to practice on your own, and feel free to experiment.", duration: 10, scale: 1.0, offset: CGSize(width: 0, height: 0)),
        Instruction(id: 22, handsposition: handposition(left: .lefthand, right: .righthand), text: "Use any posture or position that helps you feel calm, and let go of the rest.", duration: 10, scale: 1.0, offset: .zero),
