...
class InstructionViewModel {
    ...
    private let instructionsByLanguage: [String: [Instruction]] = [
        ...
        "it": [Instruction(id: 1, handsposition: handposition(left: .lefthand, right: .righthand), text: "Iniziamo insieme, prendendoci un momento per ascoltare. Fai in modo che il tuo corpo si senta comodo e preparato a seguire il movimento.", duration: 4.5, scale: 1.0, offset: .zero),
               ...
               Instruction(id: 9, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Inizia ora a spostare lentamente le mani verso i tuoi bicipiti, facendo scivolare la mano destra e la mano sinistra lungo le braccia, senza fretta.", duration: 8.6, scale: 1.3, offset: CGSize(width: 0, height: 10)),
               Instruction(id: 10, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Prenditi un momento per sentire le tue due mani che si muovono insieme, come se fossero mani gentili che ti offrono calore e cura.", duration: 7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
               Instruction(id: 11, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Con calma, muovi entrambe le mani verso i gomiti.", duration: 2.7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
               Instruction(id: 12, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Se vuoi, puoi far scivolare lentamente i pollici, esplorando questa sensazione di contatto.", duration: 4.4, scale: 1.3, offset: CGSize(width: 0, height: 10)),
               ...
               Instruction(id: 15, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Cosa provi quando ti sostieni con gentilezza, come farebbe un amico affettuoso?", duration: 3.45, scale: 1.3, offset: CGSize(width: 0, height: 10)),
               Instruction(id: 16, handsposition: handposition(left: .lefthand, right: .righthand), text: "Ora, sposta lentamente entrambe le mani verso il basso lungo le braccia, e uniscile insieme, come se volessi unire il cuore delle tue mani.", duration: 7, scale: 1.0, offset: .zero),
               ...
               Instruction(id: 19, handsposition: handposition(left: .heart, right: .stomach), text: "Porta la tua attenzione sul battito del cuore, lasciando che il respiro ti accompagni.", duration: 4.5, scale: 1.5, offset: CGSize(width: 0, height: 150)),
               Instruction(id: 20, handsposition: handposition(left: .heart, right: .stomach), text: "Cosa succede nel tuo corpo, nella tua mente, quando offri a te stesso un tocco gentile, proprio come faresti per un amico?", duration: 8.2, scale: 1.5, offset: CGSize(width: 0, height: 150)),
               ...
               Instruction(id: 22, handsposition: handposition(left: .lefthand, right: .righthand), text: "Usa la posizione che ti fa sentire più calmo e sereno, lasciando andare tutto il resto.", duration: 5.2, scale: 1.0, offset: .zero),
               Instruction(id: 23, handsposition: handposition(left: .lefthand, right: .righthand), text: "Ascolta cosa il tuo corpo ti sta dicendo, fidandoti della sua saggezza.", duration: 4.5, scale: 1.0, offset: .zero)
            ],
        "fr": [
