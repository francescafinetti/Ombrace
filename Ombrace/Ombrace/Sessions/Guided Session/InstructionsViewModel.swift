...
class InstructionViewModel {
    ...
    private let instructionsByLanguage: [String: [Instruction]] = [
        "en": [
        Instruction(id: 1, handsposition: handposition(left: .lefthand, right: .righthand), text: "Let’s begin together, taking a moment to listen. Make sure your body feels comfortable and ready to follow the movement.", duration: 9, scale: 1.0, offset: .zero),
             Instruction(id: 2, handsposition: handposition(left: .lefthand, right: .righthand), text: "Try to follow my gestures, but remember you can go at your own pace. There’s no rush.", duration: 11, scale: 1.0, offset: .zero),
             ...
             Instruction(id: 4, handsposition: handposition(left: .rightcheek, right: .righthand), text: "If you’d like, you can close your eyes to focus more on the sensations your body is experiencing.", duration: 8, scale: 2.2, offset: CGSize(width: 0, height: 400)),
             Instruction(id: 5, handsposition: handposition(left: .rightcheek, right: .righthand), text: "Stay with the sensation of contact with your hand, without rushing. Simply notice how it makes you feel.", duration: 11, scale: 2.2, offset: CGSize(width: 0, height: 400)),
             Instruction(id: 6, handsposition: handposition(left: .rightShoulder, right: .righthand), text: "Now, slowly move your left hand to your right shoulder, as if you want to cradle yourself gently with the touch.", duration: 12, scale: 2, offset: CGSize(width: -150, height: 300)),
             Instruction(id: 7, handsposition: handposition(left: .rightShoulder, right: .leftShoulder), text: "Move your right hand and place it gently on your left shoulder, so that both shoulders are supported by your hands.", duration: 10, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 8, handsposition: handposition(left: .rightShoulder, right: .leftShoulder), text: "How does this sensation feel? Stay for a moment and experience it.", duration: 7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 9, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Now slowly move your hands down to your biceps, letting your right and left hands slide down your arms, at your own pace.", duration: 14, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 10, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Take a moment to feel your two hands moving together, as if they are gentle hands offering warmth and care.", duration: 11, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 11, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Calmly, move both hands toward your elbows.", duration: 6, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             ...
             Instruction(id: 13, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "This position is very practical, and you can use it whenever you want, anywhere, to feel supported.", duration: 9, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 14, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Give yourself a little squeeze, as if you’re offering yourself a gentle hug with love.", duration: 8, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 15, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "What do you feel when you support yourself gently, just like a kind friend would?", duration: 7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
             Instruction(id: 16, handsposition: handposition(left: .lefthand, right: .righthand), text: "Now, slowly move both hands down your arms, bringing them together as if you want to unite the hearts of your hands.", duration: 12, scale: 1.0, offset: .zero),
             Instruction(id: 17, handsposition: handposition(left: .lefthand, right: .righthand), text: "Make soft movements, as if you’re gently caressing yourself with tenderness.", duration: 10, scale: 1.1, offset: .zero),
             Instruction(id: 18, handsposition: handposition(left: .heart, right: .stomach), text: "Now, move your left hand over your heart and your right hand over your stomach, as if appreciating these two important spaces of your body.", duration: 13, scale: 1.5, offset: CGSize(width: 0, height: 15)),
             ...
             Instruction(id: 20, handsposition: handposition(left: .heart, right: .stomach), text: "What happens in your body and mind when you offer yourself a gentle touch, just like you would for a friend?", duration: 10, scale: 1.5, offset: CGSize(width: 0, height: 150)),
             ...
             Instruction(id: 22, handsposition: handposition(left: .lefthand, right: .righthand), text: "Use the position that makes you feel calmer and more serene, letting go of everything else.", duration: 8, scale: 1.0, offset: .zero),
             Instruction(id: 23, handsposition: handposition(left: .lefthand, right: .righthand), text: "Listen to what your body is telling you, trusting its wisdom.", duration: 13, scale: 1.0, offset: CGSize(width: 0, height: 0))
         ],
        "it": [Instruction(id: 1, handsposition: handposition(left: .lefthand, right: .righthand), text: "Iniziamo insieme, prendendoci un momento per ascoltare. Fai in modo che il tuo corpo si senta comodo e preparato a seguire il movimento.", duration: 7, scale: 1.0, offset: .zero),
                Instruction(id: 2, handsposition: handposition(left: .lefthand, right: .righthand), text: "Prova a seguire i miei gesti, ma ricorda che puoi andare al tuo ritmo. Non c’è fretta.", duration: 8, scale: 1.0, offset: .zero),
                Instruction(id: 3, handsposition: handposition(left: .rightcheek, right: .righthand), text: "Inizia portando la tua mano sinistra delicatamente verso la tua guancia destra, come se volessi accarezzare dolcemente il tuo viso con il palmo.", duration: 19, scale: 2.2, offset: CGSize(width: 0, height: 400)),
                Instruction(id: 4, handsposition: handposition(left: .rightcheek, right: .righthand), text: "Se ti fa piacere, puoi chiudere gli occhi per concentrarti di più sulle sensazioni che il tuo corpo sta vivendo.", duration: 5, scale: 2.2, offset: CGSize(width: 0, height: 400)),
                Instruction(id: 5, handsposition: handposition(left: .rightcheek, right: .righthand), text: "Rimani a sentire la sensazione di contatto con la mano, senza fretta. Semplicemente nota come ti fa sentire.", duration: 14, scale: 2.2, offset: CGSize(width: 0, height: 400)),
                Instruction(id: 6, handsposition: handposition(left: .rightShoulder, right: .righthand), text: "Ora, porta lentamente la mano sinistra sulla spalla destra, come se volessi cullarti delicatamente con il tocco.", duration: 11, scale: 2, offset: CGSize(width: -150, height: 300)),
                Instruction(id: 7, handsposition: handposition(left: .rightShoulder, right: .leftShoulder), text: "Muovi la mano destra e appoggiala con dolcezza sulla tua spalla sinistra, così da sentire entrambe le spalle supportate dalle mani.", duration: 8, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 8, handsposition: handposition(left: .rightShoulder, right: .leftShoulder), text: "Come ti sembra questa sensazione? Resta un momento a percepirla.", duration: 5, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 9, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Inizia ora a spostare lentamente le mani verso i tuoi bicipiti, facendo scivolare la mano destra e la mano sinistra lungo le braccia, senza fretta.", duration: 10, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 10, handsposition: handposition(left: .rightarm, right: .leftarm), text: "Prenditi un momento per sentire le tue due mani che si muovono insieme, come se fossero mani gentili che ti offrono calore e cura.", duration: 10, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 11, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Con calma, muovi entrambe le mani verso i gomiti.", duration: 5, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 12, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Se vuoi, puoi far scivolare lentamente i pollici, esplorando questa sensazione di contatto.", duration: 8, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 13, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Questa posizione è molto pratica e puoi usarla quando vuoi, ovunque ti trovi, per sentirti supportato.", duration: 8, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 14, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Datti una piccola stretta, come un abbraccio gentile che ti offri con amore.", duration: 7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 15, handsposition: handposition(left: .rightelbow, right: .leftelbow), text: "Cosa provi quando ti sostieni con gentilezza, come farebbe un amico affettuoso?", duration: 7, scale: 1.3, offset: CGSize(width: 0, height: 10)),
                Instruction(id: 16, handsposition: handposition(left: .lefthand, right: .righthand), text: "Ora, sposta lentamente entrambe le mani verso il basso lungo le braccia, e uniscile insieme, come se volessi unire il cuore delle tue mani.", duration: 13, scale: 1.0, offset: .zero),
                Instruction(id: 17, handsposition: handposition(left: .lefthand, right: .righthand), text: "Fai dei movimenti delicati, come se stessi accarezzando te stesso con dolcezza.", duration: 7, scale: 1.1, offset: .zero),
                Instruction(id: 18, handsposition: handposition(left: .heart, right: .stomach), text: "Ora sposta la mano sinistra sopra il tuo cuore, e la mano destra sopra la tua pancia, come a voler apprezzare questi due spazi importanti del tuo corpo.", duration: 13, scale: 1.5, offset: CGSize(width: 0, height: 15)),
                Instruction(id: 19, handsposition: handposition(left: .heart, right: .stomach), text: "Porta la tua attenzione sul battito del cuore, lasciando che il respiro ti accompagni.", duration: 7, scale: 1.5, offset: CGSize(width: 0, height: 150)),
                Instruction(id: 20, handsposition: handposition(left: .heart, right: .stomach), text: "Cosa succede nel tuo corpo, nella tua mente, quando offri a te stesso un tocco gentile, proprio come faresti per un amico?", duration: 12, scale: 1.5, offset: CGSize(width: 0, height: 150)),
                Instruction(id: 21, handsposition: handposition(left: .lefthand, right: .righthand), text: "Ti invito ora a provare da solo, esplorando il movimento e sentendo cosa ti fa star meglio.", duration: 10, scale: 1.0, offset: .zero),
                Instruction(id: 22, handsposition: handposition(left: .lefthand, right: .righthand), text: "Usa la posizione che ti fa sentire più calmo e sereno, lasciando andare tutto il resto.", duration: 7, scale: 1.0, offset: .zero),
                Instruction(id: 23, handsposition: handposition(left: .lefthand, right: .righthand), text: "Ascolta cosa il tuo corpo ti sta dicendo, fidandoti della sua saggezza.", duration: 7, scale: 1.0, offset: .zero)
            ],
        "fr": [
